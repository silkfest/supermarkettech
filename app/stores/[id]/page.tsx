...
import {
  ...
  Thermometer, Wind, RefrigeratorIcon,
} from 'lucide-react'
      ...
      <div className="flex-1 min-w-0">
        ...
        {isEditing ? (
          <div className="flex items-center gap-2 mt-0.5">
            ...
            />
            <button
              onClick={() => onSave(fieldKey, editVal)}
              disabled={saving}
          ...
          <p className="text-sm text-slate-800 truncate">{value || <span className="text-slate-400 italic">Not set</span>}</p>
        )}
      </div>
      {isAdmin && !isEditing && (
        <button
