...
import { Plus, X, MessageCircle, Clock, Tag, ChevronRight, HelpCircle } from 'lucide-react'
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. refrigeration, txv, subcooling, rack-style-2"
                    className="w-full text-sm border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                {error && (
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">
                Be the first to ask your team something
              </p>
              <button
            ...
            <div className="space-y-2.5">
              {questions.map(q => (
                <button
                  ...
                  className="w-full bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 p-4 text-left transition-all group"
                >
