...
- Three-phase 575V (Canadian): 1.0–1.2 A/hp
...
- **Electrical after dash:** T = 3-phase, W = single-phase; F = 208–230V, D = 460V, Y = 575V (Canadian), M = 200–220V/50Hz
...
**Model number prefix decode:** Number = cylinder count; D = Discus valve; N = no unloaders; R = with unloaders; electrical suffix same convention as scroll (TFD = 3-phase 460V; TYD = 3-phase 575V Canadian)
...
| 600V 3-ph (CA) | — | ≈ 1.0 A per 1,000 W |
...
- **Line voltage section** (top or left): L1–L2 or L1–L2–L3 at 120/208/240/480V (or 600V in Canadian installations); compressor contactor power contacts, condenser fan contactors, heater contactors, transformer primary
...
DC bus voltage ≈ 1.35× line voltage. 480V system = ~650V DC bus. 600V system (Canadian) = ~810V DC bus.
...
- **4** = 3-phase 460V (US); Canadian units typically use 575V — check unit nameplate
- **B** = design sequence
...
- **L** = 460V/60Hz/3-phase (US); Canadian equivalent is 575V/600V — verify nameplate
- **A** = design sequence
...
- Transformer primary: verify line voltage matches transformer primary tap (208, 230, or 460V; Canadian installations may use 575V or 600V tap)
