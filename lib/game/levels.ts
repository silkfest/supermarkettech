...
export const LEVELS: LevelDef[] = [
  ...
  },
  {
    ...
    faultPool: [
      ...
      'pan_heater',
      'defrost_heater_open', 'defrost_schedule_cut', 'door_closer_failed', 'anti_sweat_control',
      'liquid_solenoid_stuck', 'reachin_gasket', 'chest_freezer_gasket', 'split_ac_iced',
      'condensing_unit_short_cycle', 'overload_tripped', 'walkin_timer_failed', 'walkin_evap_fan',
      'ice_water_valve', 'ice_bin_switch', 'water_filter_plugged', 'ice_condenser_plugged',
      'ice_harvest_stuck', 'grease_trap_backup',
    ],
    shiftLenMin: 6 * 60,
  ...
  },
  {
    ...
    faultPool: [
      ...
      'condensate_clog', 'frozen_drain', 'dry_trap', 'rtu_drain_trap',
      'economizer_stuck', 'filter_clogged', 'negative_pressure',
      'defrost_heater_open', 'evap_fan_motor', 'night_curtain', 'overstocked_case',
      'case_probe_drift', 'epr_misadjusted', 'liquid_solenoid_stuck', 'defrost_schedule_cut',
      'honeycomb_blocked', 'drain_line_broken', 'door_closer_failed', 'anti_sweat_control',
      'txv_moisture_freeze', 'case_fan_blade', 'bunker_lid_gasket', 'produce_mister',
      'rtu_no_heat_flame', 'rtu_belt', 'rtu_hpco', 'rtu_econ_actuator',
      'control_transformer', 'rtu_dirty_evap', 'rtu_zone_sensor', 'low_charge',
      'noncondensables', 'liquid_drier_plugged', 'oil_regulator_stuck', 'crankcase_heater',
      'compressor_grounded', 'phase_loss', 'overcharge', 'suction_filter_plugged',
      'winter_head_pressure', 'oil_separator_return', 'unloader_stuck', 'walkin_pressure_port',
      'walkin_timer_failed', 'walkin_evap_fan', 'defrost_contactor_coil', 'grease_trap_backup',
    ],
    shiftLenMin: 8 * 60,
  ...
  },
  {
    ...
    faultPool: [
      ...
      'fan_shorted', 'economizer_stuck', 'filter_clogged', 'rtu_drain_trap',
      'defrost_heater_open', 'evap_fan_motor', 'night_curtain', 'overstocked_case',
      'case_probe_drift', 'epr_misadjusted', 'liquid_solenoid_stuck', 'defrost_schedule_cut',
      'honeycomb_blocked', 'drain_line_broken', 'door_closer_failed', 'anti_sweat_control',
      'txv_moisture_freeze', 'case_fan_blade', 'bunker_lid_gasket', 'produce_mister',
      'rtu_no_heat_flame', 'rtu_belt', 'rtu_hpco', 'rtu_econ_actuator',
      'control_transformer', 'rtu_dirty_evap', 'rtu_zone_sensor', 'grease_trap_backup',
    ],
    shiftLenMin: 8 * 60,
  ...
  },
  {
    ...
    faultPool: [
      ...
      'dt_failed_open', 'door_ajar', 'txv_starved', 'condensate_clog', 'dry_trap',
      'fan_shorted', 'contactor_burned', 'contactor_welded', 'filter_clogged', 'rtu_drain_trap',
      'defrost_heater_open', 'evap_fan_motor', 'night_curtain', 'overstocked_case',
      'case_probe_drift', 'epr_misadjusted', 'liquid_solenoid_stuck', 'defrost_schedule_cut',
      'honeycomb_blocked', 'drain_line_broken', 'door_closer_failed', 'anti_sweat_control',
      'txv_moisture_freeze', 'case_fan_blade', 'bunker_lid_gasket', 'produce_mister',
      ...
      'noncondensables', 'liquid_drier_plugged', 'oil_regulator_stuck', 'crankcase_heater',
      'compressor_grounded', 'phase_loss', 'overcharge', 'suction_filter_plugged',
      'oil_separator_return', 'grease_trap_backup',
    ],
    shiftLenMin: 8 * 60,
    spawnAt: { apprentice: [0, 75, 150, 225, 300, 375], journeyman: [0, 40, 85, 135, 185, 235, 285, 335, 385] },
    maxOpen: { apprentice: 2, journeyman: 3 },
  ...
  },
  {
    ...
    faultPool: [
      ...
      'economizer_stuck', 'filter_clogged', 'rtu_drain_trap',
      'defrost_heater_open', 'evap_fan_motor', 'night_curtain', 'overstocked_case',
      'case_probe_drift', 'liquid_solenoid_stuck', 'defrost_schedule_cut', 'honeycomb_blocked',
      'drain_line_broken', 'door_closer_failed', 'anti_sweat_control', 'case_fan_blade',
      'bunker_lid_gasket', 'produce_mister', 'rtu_no_heat_flame', 'rtu_belt',
      'rtu_hpco', 'rtu_econ_actuator', 'control_transformer', 'rtu_dirty_evap',
      'rtu_zone_sensor', 'low_charge', 'noncondensables', 'liquid_drier_plugged',
      'oil_regulator_stuck', 'crankcase_heater', 'compressor_grounded', 'phase_loss',
      'overcharge', 'suction_filter_plugged', 'winter_head_pressure', 'oil_separator_return',
      'unloader_stuck', 'walkin_pressure_port', 'defrost_contactor_coil', 'grease_trap_backup',
    ],
    shiftLenMin: 8 * 60,
    spawnAt: { apprentice: [0, 75, 150, 225, 300, 375], journeyman: [0, 40, 85, 135, 185, 235, 285, 335, 385] },
    maxOpen: { apprentice: 2, journeyman: 3 },
  ...
  },
  {
    ...
    faultPool: [
      ...
      'dt_failed_open', 'door_ajar', 'txv_starved', 'condensate_clog', 'dry_trap',
      'fan_shorted', 'contactor_welded', 'economizer_stuck', 'filter_clogged', 'rtu_drain_trap',
      'defrost_heater_open', 'evap_fan_motor', 'night_curtain', 'overstocked_case',
      'case_probe_drift', 'epr_misadjusted', 'liquid_solenoid_stuck', 'defrost_schedule_cut',
      'honeycomb_blocked', 'drain_line_broken', 'door_closer_failed', 'anti_sweat_control',
      'txv_moisture_freeze', 'case_fan_blade', 'bunker_lid_gasket', 'produce_mister',
      ...
      'noncondensables', 'liquid_drier_plugged', 'oil_regulator_stuck', 'crankcase_heater',
      'compressor_grounded', 'phase_loss', 'overcharge', 'suction_filter_plugged',
      'winter_head_pressure', 'oil_separator_return', 'unloader_stuck', 'grease_trap_backup',
    ],
    shiftLenMin: 8 * 60,
    spawnAt: { apprentice: [0, 75, 150, 225, 300, 375], journeyman: [0, 40, 85, 135, 185, 235, 285, 335, 385] },
    maxOpen: { apprentice: 2, journeyman: 3 },
