...
// A legacy Tyler parallel rack on R-404A with Nature's Cooling and
// EnviroGuard III condenser control — floating head pressure, an OPR gas
// bypass holding minimum receiver pressure, an NC-2 liquid bypass preserving
// natural subcooling, heat reclaim into the store, and hot gas defrost that
// has to work with whatever head pressure the weather leaves you. The
// machine room is on a mezzanine, the way the Tyler manual assumes.
export const TYLER_STORE_MAP: GameMap = {
  w: 1000,
  h: 600,
  floor: 'tile',
  obstacles: [
    ...
    // Mezzanine stair door — the gap at y 170-250.
    { x: 660, y: 20, w: 20, h: 150, kind: 'wall' },
    { x: 660, y: 250, w: 20, h: 330, kind: 'wall' },
    // Mezzanine / roof pad — service door at x 880-940.
  ...
  zones: [
    ...
    { label: 'MEZZANINE MACHINE ROOM', x: 830, y: 34 },
  ...
  equipment: [
    ...
    { id: 'RK', label: 'Tyler parallel rack (R-404A)', kind: 'rack', rect: { x: 700, y: 50, w: 200, h: 75 }, pin: { x: 800, y: 88 }, stand: { x: 800, y: 160 } },
    { id: 'RCV', label: 'Receiver + OPR / NC-2 bypass', kind: 'receiver', rect: { x: 700, y: 200, w: 140, h: 60 }, pin: { x: 770, y: 230 }, stand: { x: 770, y: 305 } },
    { id: 'CD1', label: 'Remote condenser (EnviroGuard III)', kind: 'condenser', rect: { x: 700, y: 425, w: 200, h: 70 }, pin: { x: 800, y: 460 }, stand: { x: 800, y: 545 } },
    { id: 'RTU1', label: 'RTU-1 (sales floor, heat reclaim)', kind: 'rtu', rect: { x: 915, y: 425, w: 55, h: 80 }, pin: { x: 942, y: 465 }, stand: { x: 890, y: 545 } },
