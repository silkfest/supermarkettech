...
export const CO2_STORE_MAP: GameMap = {
  ...
  equipment: [
    ...
    { id: 'GC', label: 'Gas cooler (transcritical)', kind: 'gas-cooler', rect: { x: 700, y: 415, w: 190, h: 70 }, pin: { x: 795, y: 450 }, stand: { x: 795, y: 530 } },
    { id: 'RTU1', label: 'RTU-1 (sales floor)', kind: 'rtu', rect: { x: 910, y: 415, w: 55, h: 80 }, pin: { x: 937, y: 455 }, stand: { x: 910, y: 530 } },
